...
const sv_completion_tick: string[][] = [
    ...
    ["else", "`else", "else\n${0}"],
    ["include", "`include", "include \"${1:filename}\""],
    ["line", " level", " ${3:level}"],
    ...
    //# __built__
    ["uvm_add_to_seq_lib", "`uvm_add_to_seq_lib", "uvm_add_to_seq_lib"],
    ["uvm_analysis_imp_decl", "`uvm_analysis_imp_decl", "uvm_analysis_imp_decl"],
    ["uvm_blocking_get_imp_decl", "`uvm_blocking_get_imp_decl", "uvm_blocking_get_imp_decl"],
    ["uvm_blocking_get_peek_imp_decl", "`uvm_blocking_get_peek_imp_decl", "uvm_blocking_get_peek_imp_decl"],
    ["uvm_blocking_master_imp_decl", "`uvm_blocking_master_imp_decl", "uvm_blocking_master_imp_decl"],
    ["uvm_blocking_peek_imp_decl", "`uvm_blocking_peek_imp_decl", "uvm_blocking_peek_imp_decl"],
    ["uvm_blocking_put_imp_decl", "`uvm_blocking_put_imp_decl", "uvm_blocking_put_imp_decl"],
    ["uvm_blocking_slave_imp_decl", "`uvm_blocking_slave_imp_decl", "uvm_blocking_slave_imp_decl"],
    ["uvm_blocking_transport_imp_decl", "`uvm_blocking_transport_imp_decl", "uvm_blocking_transport_imp_decl"],
    ["uvm_builtin_bottomup_phase", "`uvm_builtin_bottomup_phase", "uvm_builtin_bottomup_phase"],
    ["uvm_builtin_task_phase", "`uvm_builtin_task_phase", "uvm_builtin_task_phase"],
    ["uvm_builtin_topdown_phase", "`uvm_builtin_topdown_phase", "uvm_builtin_topdown_phase"],
    ["uvm_cb_trace", "`uvm_cb_trace", "uvm_cb_trace"],
    ["uvm_cb_trace_noobj", "`uvm_cb_trace_noobj", "uvm_cb_trace_noobj"],
    ["uvm_component_param_utils", "`uvm_component_param_utils", "uvm_component_param_utils"],
    ["uvm_component_param_utils_begin", "`uvm_component_param_utils_begin", "uvm_component_param_utils_begin"],
    ["uvm_component_registry", "`uvm_component_registry", "uvm_component_registry"],
    ["uvm_component_utils", "`uvm_component_utils", "uvm_component_utils"],
    ["uvm_component_utils_begin", "`uvm_component_utils_begin", "uvm_component_utils_begin"],
    ["uvm_component_utils_end", "`uvm_component_utils_end", "uvm_component_utils_end"],
    ["uvm_create", "`uvm_create", "uvm_create"],
    ["uvm_create_on", "`uvm_create_on", "uvm_create_on"],
    ["uvm_create_seq", "`uvm_create_seq", "uvm_create_seq"],
    ["uvm_declare_p_sequencer", "`uvm_declare_p_sequencer", "uvm_declare_p_sequencer"],
    ["uvm_declare_sequence_lib", "`uvm_declare_sequence_lib", "uvm_declare_sequence_lib"],
    ["uvm_delay", "`uvm_delay", "uvm_delay"],
    ["uvm_do", "`uvm_do", "uvm_do"],
    ["uvm_do_callbacks", "`uvm_do_callbacks", "uvm_do_callbacks"],
    ["uvm_do_callbacks_exit_on", "`uvm_do_callbacks_exit_on", "uvm_do_callbacks_exit_on"],
    ["uvm_do_obj_callbacks", "`uvm_do_obj_callbacks", "uvm_do_obj_callbacks"],
    ["uvm_do_obj_callbacks_exit_on", "`uvm_do_obj_callbacks_exit_on", "uvm_do_obj_callbacks_exit_on"],
    ["uvm_do_on", "`uvm_do_on", "uvm_do_on"],
    ["uvm_do_on_pri", "`uvm_do_on_pri", "uvm_do_on_pri"],
    ["uvm_do_on_pri_with", "`uvm_do_on_pri_with", "uvm_do_on_pri_with"],
    ["uvm_do_on_with", "`uvm_do_on_with", "uvm_do_on_with"],
    ["uvm_do_pri", "`uvm_do_pri", "uvm_do_pri"],
    ["uvm_do_pri_with", "`uvm_do_pri_with", "uvm_do_pri_with"],
    ["uvm_do_seq", "`uvm_do_seq", "uvm_do_seq"],
    ["uvm_do_seq_with", "`uvm_do_seq_with", "uvm_do_seq_with"],
    ["uvm_do_with", "`uvm_do_with", "uvm_do_with"],
    ["uvm_end_package", "`uvm_end_package", "uvm_end_package"],
    ["uvm_error", "`uvm_error", "uvm_error"],
    ["uvm_error_begin", "`uvm_error_begin", "uvm_error_begin"],
    ["uvm_error_context", "`uvm_error_context", "uvm_error_context"],
    ["uvm_error_context_begin", "`uvm_error_context_begin", "uvm_error_context_begin"],
    ["uvm_error_context_end", "`uvm_error_context_end", "uvm_error_context_end"],
    ["uvm_error_end", "`uvm_error_end", "uvm_error_end"],
    ["uvm_fatal", "`uvm_fatal", "uvm_fatal"],
    ["uvm_fatal_begin", "`uvm_fatal_begin", "uvm_fatal_begin"],
    ["uvm_fatal_context", "`uvm_fatal_context", "uvm_fatal_context"],
    ["uvm_fatal_context_begin", "`uvm_fatal_context_begin", "uvm_fatal_context_begin"],
    ["uvm_fatal_context_end", "`uvm_fatal_context_end", "uvm_fatal_context_end"],
    ["uvm_fatal_end", "`uvm_fatal_end", "uvm_fatal_end"],
    ["uvm_field_aa_int_byte", "`uvm_field_aa_int_byte", "uvm_field_aa_int_byte"],
    ["uvm_field_aa_int_byte_unsigned", "`uvm_field_aa_int_byte_unsigned", "uvm_field_aa_int_byte_unsigned"],
    ["uvm_field_aa_int_enumkey", "`uvm_field_aa_int_enumkey", "uvm_field_aa_int_enumkey"],
    ["uvm_field_aa_int_int", "`uvm_field_aa_int_int", "uvm_field_aa_int_int"],
    ["uvm_field_aa_int_int_unsigned", "`uvm_field_aa_int_int_unsigned", "uvm_field_aa_int_int_unsigned"],
    ["uvm_field_aa_int_integer", "`uvm_field_aa_int_integer", "uvm_field_aa_int_integer"],
    ["uvm_field_aa_int_integer_unsigned", "`uvm_field_aa_int_integer_unsigned", "uvm_field_aa_int_integer_unsigned"],
    ["uvm_field_aa_int_key", "`uvm_field_aa_int_key", "uvm_field_aa_int_key"],
    ["uvm_field_aa_int_longint", "`uvm_field_aa_int_longint", "uvm_field_aa_int_longint"],
    ["uvm_field_aa_int_longint_unsigned", "`uvm_field_aa_int_longint_unsigned", "uvm_field_aa_int_longint_unsigned"],
    ["uvm_field_aa_int_shortint", "`uvm_field_aa_int_shortint", "uvm_field_aa_int_shortint"],
    ["uvm_field_aa_int_shortint_unsigned", "`uvm_field_aa_int_shortint_unsigned", "uvm_field_aa_int_shortint_unsigned"],
    ["uvm_field_aa_int_string", "`uvm_field_aa_int_string", "uvm_field_aa_int_string"],
    ["uvm_field_aa_object_int", "`uvm_field_aa_object_int", "uvm_field_aa_object_int"],
    ["uvm_field_aa_object_string", "`uvm_field_aa_object_string", "uvm_field_aa_object_string"],
    ...
    ["uvm_field_utils_begin", "`uvm_field_utils_begin", "uvm_field_utils_begin"],
    ["uvm_field_utils_end", "`uvm_field_utils_end", "uvm_field_utils_end"],
    ["uvm_file", "`uvm_file", "uvm_file"],
    ["uvm_get_imp_decl", "`uvm_get_imp_decl", "uvm_get_imp_decl"],
    ["uvm_get_peek_imp_decl", "`uvm_get_peek_imp_decl", "uvm_get_peek_imp_decl"],
    ["uvm_info", "`uvm_info", "uvm_info"],
    ["uvm_info_begin", "`uvm_info_begin", "uvm_info_begin"],
    ["uvm_info_context", "`uvm_info_context", "uvm_info_context"],
    ["uvm_info_context_begin", "`uvm_info_context_begin", "uvm_info_context_begin"],
    ["uvm_info_context_end", "`uvm_info_context_end", "uvm_info_context_end"],
    ["uvm_info_end", "`uvm_info_end", "uvm_info_end"],
    ["uvm_line", "`uvm_line", "uvm_line"],
    ["uvm_master_imp_decl", "`uvm_master_imp_decl", "uvm_master_imp_decl"],
    ["uvm_message_add_int", "`uvm_message_add_int", "uvm_message_add_int"],
    ["uvm_message_add_object", "`uvm_message_add_object", "uvm_message_add_object"],
    ["uvm_message_add_string", "`uvm_message_add_string", "uvm_message_add_string"],
    ["uvm_message_add_tag", "`uvm_message_add_tag", "uvm_message_add_tag"],
    ["uvm_message_begin", "`uvm_message_begin", "uvm_message_begin"],
    ["uvm_message_context_begin", "`uvm_message_context_begin", "uvm_message_context_begin"],
    ["uvm_message_context_end", "`uvm_message_context_end", "uvm_message_context_end"],
    ["uvm_message_end", "`uvm_message_end", "uvm_message_end"],
    ["uvm_new_func", "`uvm_new_func", "uvm_new_func"],
    ["uvm_non_blocking_transport_imp_decl", "`uvm_non_blocking_transport_imp_decl", "uvm_non_blocking_transport_imp_decl"],
    ["uvm_nonblocking_get_imp_decl", "`uvm_nonblocking_get_imp_decl", "uvm_nonblocking_get_imp_decl"],
    ["uvm_nonblocking_get_peek_imp_decl", "`uvm_nonblocking_get_peek_imp_decl", "uvm_nonblocking_get_peek_imp_decl"],
    ["uvm_nonblocking_master_imp_decl", "`uvm_nonblocking_master_imp_decl", "uvm_nonblocking_master_imp_decl"],
    ["uvm_nonblocking_peek_imp_decl", "`uvm_nonblocking_peek_imp_decl", "uvm_nonblocking_peek_imp_decl"],
    ["uvm_nonblocking_put_imp_decl", "`uvm_nonblocking_put_imp_decl", "uvm_nonblocking_put_imp_decl"],
    ["uvm_nonblocking_slave_imp_decl", "`uvm_nonblocking_slave_imp_decl", "uvm_nonblocking_slave_imp_decl"],
    ["uvm_nonblocking_transport_imp_decl", "`uvm_nonblocking_transport_imp_decl", "uvm_nonblocking_transport_imp_decl"],
    ["uvm_object_param_utils", "`uvm_object_param_utils", "uvm_object_param_utils"],
    ["uvm_object_param_utils_begin", "`uvm_object_param_utils_begin", "uvm_object_param_utils_begin"],
    ["uvm_object_registry", "`uvm_object_registry", "uvm_object_registry"],
    ["uvm_object_utils", "`uvm_object_utils", "uvm_object_utils"],
    ["uvm_object_utils_begin", "`uvm_object_utils_begin", "uvm_object_utils_begin"],
    ["uvm_object_utils_end", "`uvm_object_utils_end", "uvm_object_utils_end"],
    ["uvm_pack_array", "`uvm_pack_array", "uvm_pack_array"],
    ["uvm_pack_arrayN", "`uvm_pack_arrayN", "uvm_pack_arrayN"],
    ["uvm_pack_enum", "`uvm_pack_enum", "uvm_pack_enum"],
    ["uvm_pack_enumN", "`uvm_pack_enumN", "uvm_pack_enumN"],
    ["uvm_pack_int", "`uvm_pack_int", "uvm_pack_int"],
    ["uvm_pack_intN", "`uvm_pack_intN", "uvm_pack_intN"],
    ["uvm_pack_queue", "`uvm_pack_queue", "uvm_pack_queue"],
    ["uvm_pack_queueN", "`uvm_pack_queueN", "uvm_pack_queueN"],
    ["uvm_pack_real", "`uvm_pack_real", "uvm_pack_real"],
    ["uvm_pack_sarray", "`uvm_pack_sarray", "uvm_pack_sarray"],
    ["uvm_pack_sarrayN", "`uvm_pack_sarrayN", "uvm_pack_sarrayN"],
    ["uvm_pack_string", "`uvm_pack_string", "uvm_pack_string"],
    ["uvm_package", "`uvm_package", "uvm_package"],
    ["uvm_peek_imp_decl", "`uvm_peek_imp_decl", "uvm_peek_imp_decl"],
    ["uvm_print_aa_int_key4", "`uvm_print_aa_int_key4", "uvm_print_aa_int_key4"],
    ["uvm_print_aa_int_object", "`uvm_print_aa_int_object", "uvm_print_aa_int_object"],
    ["uvm_print_aa_int_object3", "`uvm_print_aa_int_object3", "uvm_print_aa_int_object3"],
    ["uvm_print_aa_string_int", "`uvm_print_aa_string_int", "uvm_print_aa_string_int"],
    ["uvm_print_aa_string_int3", "`uvm_print_aa_string_int3", "uvm_print_aa_string_int3"],
    ["uvm_print_aa_string_object", "`uvm_print_aa_string_object", "uvm_print_aa_string_object"],
    ["uvm_print_aa_string_object3", "`uvm_print_aa_string_object3", "uvm_print_aa_string_object3"],
    ["uvm_print_aa_string_string", "`uvm_print_aa_string_string", "uvm_print_aa_string_string"],
    ["uvm_print_aa_string_string2", "`uvm_print_aa_string_string2", "uvm_print_aa_string_string2"],
    ["uvm_print_array_int", "`uvm_print_array_int", "uvm_print_array_int"],
    ["uvm_print_array_int3", "`uvm_print_array_int3", "uvm_print_array_int3"],
    ["uvm_print_array_object", "`uvm_print_array_object", "uvm_print_array_object"],
    ["uvm_print_array_object3", "`uvm_print_array_object3", "uvm_print_array_object3"],
    ["uvm_print_array_string", "`uvm_print_array_string", "uvm_print_array_string"],
    ["uvm_print_array_string2", "`uvm_print_array_string2", "uvm_print_array_string2"],
    ["uvm_print_enum", "`uvm_print_enum", "uvm_print_enum"],
    ["uvm_print_int", "`uvm_print_int", "uvm_print_int"],
    ["uvm_print_int3", "`uvm_print_int3", "uvm_print_int3"],
    ["uvm_print_int4", "`uvm_print_int4", "uvm_print_int4"],
    ["uvm_print_object", "`uvm_print_object", "uvm_print_object"],
    ["uvm_print_object2", "`uvm_print_object2", "uvm_print_object2"],
    ["uvm_print_object_qda4", "`uvm_print_object_qda4", "uvm_print_object_qda4"],
    ["uvm_print_object_queue", "`uvm_print_object_queue", "uvm_print_object_queue"],
    ["uvm_print_object_queue3", "`uvm_print_object_queue3", "uvm_print_object_queue3"],
    ["uvm_print_qda_enum", "`uvm_print_qda_enum", "uvm_print_qda_enum"],
    ["uvm_print_qda_int4", "`uvm_print_qda_int4", "uvm_print_qda_int4"],
    ["uvm_print_queue_int", "`uvm_print_queue_int", "uvm_print_queue_int"],
    ["uvm_print_queue_int3", "`uvm_print_queue_int3", "uvm_print_queue_int3"],
    ["uvm_print_sarray_int3", "`uvm_print_sarray_int3", "uvm_print_sarray_int3"],
    ["uvm_print_sarray_object", "`uvm_print_sarray_object", "uvm_print_sarray_object"],
    ["uvm_print_sarray_object3", "`uvm_print_sarray_object3", "uvm_print_sarray_object3"],
    ["uvm_print_sarray_string2", "`uvm_print_sarray_string2", "uvm_print_sarray_string2"],
    ["uvm_print_string", "`uvm_print_string", "uvm_print_string"],
    ["uvm_print_string2", "`uvm_print_string2", "uvm_print_string2"],
    ["uvm_print_string_qda3", "`uvm_print_string_qda3", "uvm_print_string_qda3"],
    ["uvm_print_string_queue", "`uvm_print_string_queue", "uvm_print_string_queue"],
    ["uvm_print_string_queue2", "`uvm_print_string_queue2", "uvm_print_string_queue2"],
    ["uvm_put_imp_decl", "`uvm_put_imp_decl", "uvm_put_imp_decl"],
    ["uvm_rand_send", "`uvm_rand_send", "uvm_rand_send"],
    ["uvm_rand_send_pri", "`uvm_rand_send_pri", "uvm_rand_send_pri"],
    ["uvm_rand_send_pri_with", "`uvm_rand_send_pri_with", "uvm_rand_send_pri_with"],
    ["uvm_rand_send_with", "`uvm_rand_send_with", "uvm_rand_send_with"],
    ["uvm_record_attribute", "`uvm_record_attribute", "uvm_record_attribute"],
    ["uvm_record_field", "`uvm_record_field", "uvm_record_field"],
    ["uvm_record_int", "`uvm_record_int", "uvm_record_int"],
    ["uvm_record_real", "`uvm_record_real", "uvm_record_real"],
    ["uvm_record_string", "`uvm_record_string", "uvm_record_string"],
    ["uvm_record_time", "`uvm_record_time", "uvm_record_time"],
    ["uvm_register_cb", "`uvm_register_cb", "uvm_register_cb"],
    ["uvm_send", "`uvm_send", "uvm_send"],
    ["uvm_send_pri", "`uvm_send_pri", "uvm_send_pri"],
    ["uvm_sequence_library_package", "`uvm_sequence_library_package", "uvm_sequence_library_package"],
    ["uvm_sequence_library_utils", "`uvm_sequence_library_utils", "uvm_sequence_library_utils"],
    ["uvm_sequence_utils", "`uvm_sequence_utils", "uvm_sequence_utils"],
    ["uvm_sequence_utils_begin", "`uvm_sequence_utils_begin", "uvm_sequence_utils_begin"],
    ["uvm_sequence_utils_end", "`uvm_sequence_utils_end", "uvm_sequence_utils_end"],
    ["uvm_sequencer_param_utils", "`uvm_sequencer_param_utils", "uvm_sequencer_param_utils"],
    ["uvm_sequencer_param_utils_begin", "`uvm_sequencer_param_utils_begin", "uvm_sequencer_param_utils_begin"],
    ["uvm_sequencer_utils", "`uvm_sequencer_utils", "uvm_sequencer_utils"],
    ["uvm_sequencer_utils_begin", "`uvm_sequencer_utils_begin", "uvm_sequencer_utils_begin"],
    ["uvm_sequencer_utils_end", "`uvm_sequencer_utils_end", "uvm_sequencer_utils_end"],
    ["uvm_set_super_type", "`uvm_set_super_type", "uvm_set_super_type"],
    ["uvm_slave_imp_decl", "`uvm_slave_imp_decl", "uvm_slave_imp_decl"],
    ["uvm_transport_imp_decl", "`uvm_transport_imp_decl", "uvm_transport_imp_decl"],
    ["uvm_typename", "`uvm_typename", "uvm_typename"],
    ["uvm_unpack_array", "`uvm_unpack_array", "uvm_unpack_array"],
    ["uvm_unpack_arrayN", "`uvm_unpack_arrayN", "uvm_unpack_arrayN"],
    ["uvm_unpack_enum", "`uvm_unpack_enum", "uvm_unpack_enum"],
    ["uvm_unpack_enumN", "`uvm_unpack_enumN", "uvm_unpack_enumN"],
    ["uvm_unpack_int", "`uvm_unpack_int", "uvm_unpack_int"],
    ["uvm_unpack_intN", "`uvm_unpack_intN", "uvm_unpack_intN"],
    ["uvm_unpack_queue", "`uvm_unpack_queue", "uvm_unpack_queue"],
    ["uvm_unpack_queueN", "`uvm_unpack_queueN", "uvm_unpack_queueN"],
    ["uvm_unpack_real", "`uvm_unpack_real", "uvm_unpack_real"],
    ["uvm_unpack_sarray", "`uvm_unpack_sarray", "uvm_unpack_sarray"],
    ["uvm_unpack_sarrayN", "`uvm_unpack_sarrayN", "uvm_unpack_sarrayN"],
    ["uvm_unpack_string", "`uvm_unpack_string", "uvm_unpack_string"],
    ["uvm_update_sequence_lib", "`uvm_update_sequence_lib", "uvm_update_sequence_lib"],
    ["uvm_update_sequence_lib_and_item", "`uvm_update_sequence_lib_and_item", "uvm_update_sequence_lib_and_item"],
    ["uvm_user_bottomup_phase", "`uvm_user_bottomup_phase", "uvm_user_bottomup_phase"],
    ["uvm_user_task_phase", "`uvm_user_task_phase", "uvm_user_task_phase"],
    ["uvm_user_topdown_phase", "`uvm_user_topdown_phase", "uvm_user_topdown_phase"],
    ["uvm_warning", "`uvm_warning", "uvm_warning"],
    ["uvm_warning_begin", "`uvm_warning_begin", "uvm_warning_begin"],
    ["uvm_warning_context", "`uvm_warning_context", "uvm_warning_context"],
    ["uvm_warning_context_begin", "`uvm_warning_context_begin", "uvm_warning_context_begin"],
    ["uvm_warning_context_end", "`uvm_warning_context_end", "uvm_warning_context_end"],
    ["uvm_warning_end", "`uvm_warning_end", "uvm_warning_end"],
];
